if (TRUE) {
  ...
  #2.3 Install Github common packages
...
## Here is added the shape that distinguishes between lineages 
...
# Filtrado de datos, filtrado común en los dos archivos
...
# 4. Statistics and Graphics Statistics and Graphics
